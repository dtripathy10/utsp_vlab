...
function getHeader($id, $name, $type) {
   ?>
   <!DOCTYPE html>
   <html>
      <head>
         <!-- le title -->
         <title><?php echo $name; ?> | UTSP VLab</title>
            ...
            <body>
               <div id="top_container">
                  <div id="header">
                     ...
                     <h1 class="title_header"><a href="aim.php"><?php echo $name; ?></a><span class="caption"><?php echo $type; ?></span></h1>
                  </div>
                  <div id="navbar">
                     <div class="row">
                        <div class="span8">
