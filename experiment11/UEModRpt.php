...
$filename = "UserEquilibriumAssignment_" . date('YMd') . ".xls";
...
<h2> User Equilibrium Assignment </h2>
<BR>  
...
//echo $ii;
$sum=0;
echo '<div id="scroller"><table border=1 cellspacing=1 align="center" width="100%"><caption><b> Result </font></b></caption>';
	echo '<tr align="center" bgcolor="#EBF5FF">'; 
             echo '<td bgcolor="#B8DBFF">';echo "<b>From</b>"; echo "</td>";
             echo '<td bgcolor="#B8DBFF">';echo "<b>to</b>"; echo "</td>";           
             echo '<td bgcolor="#B8DBFF">';echo "<b>Xi</b>"; echo "</td>";
             echo '<td bgcolor="#B8DBFF">';echo "<b>Travel time</b>"; echo "</td>";
             //echo '<td bgcolor="#B8DBFF">';echo "<b>Total System Travel time</b>"; echo "</td>";
    echo  '</tr>';
 for ($i = 1; $i <= $m_nlinks; $i++)
        {           	
             echo '<tr align="center" bgcolor="#EBF5FF">';
             echo '<td>';echo $frm[$i]; echo "</td>";echo '<td >';echo $to[$i]; echo "</td>";           
             echo '<td>';echo $x[$i]; echo "</td>";
             echo '<td>';echo $t[$i]; echo "</td>";
             //echo '<td>'; echo ($x[$i]*$t[$i]); echo "</td>"; 
             $sum +=($x[$i]*$t[$i]);
             echo "</tr>";       
        }
        echo "</table></div><br>";
