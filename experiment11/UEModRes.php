...
function chk1()
{ 
	document.Frm.action="intermediateUserEquiilibriumModelReport.php?";	
}
/*
function chk2()
{ 
	document.Frm.action="UEModRptPdf.php?Exp=9";	
}
*/
function chkgraph()
{ 
	document.Frm.action="UEModPlot.php";	
...
function amit($x,$a,$c)
{
	...
	//alphavalue $_POST['alphaValue']
	//beta value $_POST['betaValue'];
	$time = $a+$_POST['alphaValue']*$a*pow($x/$c,$_POST['betaValue']);
	return $time;
}
...
<form enctype="multipart/form-data" method="post" name="Frm" action="AONModRes.php?Exp=9">
...
<br><br>		
		...
		<!-- 
		<tr>
  			<td align="center">&nbsp;&nbsp;<a href="AONMod.php?Exp=9"><H2><u>Back</u></H2></a>&nbsp;&nbsp;</td>
		</tr>
		-->
