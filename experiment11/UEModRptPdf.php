...
$pdf->SetTitle('Experiment: User Equilibrium Assignment');
...
$pdf->Write(0, 'Experiment No. 11 ', '', 0, 'L',false, 0, false, false, 0);
$pdf->Write(0, $datetoday, '', 0, 'R', true, 0, false, false, 0);

$pdf->Write(0, 'User Equilibirum Assignment', '', 0, 'C', true, 0, false, false, 0);
$pdf->Ln(); //new row
$pdf->Ln(); //new row
