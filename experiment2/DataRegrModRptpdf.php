...
if($file_ext1 == '.xls' )
{
	...
	// Trip File
        ...
        $dataTripF->read($UploadFile."/Experiment2/".$m_TripFile);
...
elseif($file_ext1 == '.csv' )
{
 	...
 	$nCol=0; 
	$nRow = 0;
	$name = $UploadFile."/Experiment2/".$m_TripFile;
    $file = fopen($name , "r");
...
if($m_AnalysisVar == "DataAna")
{
	...
	$pdf->Output($UploadFile.'/Experiment2/'.$m_DataChoiceVar.date("Ymdhms").'.pdf',"F");
}
elseif($m_AnalysisVar == "RegrAna")
{
	$pdf->Output($UploadFile.'/Experiment2/'.RegrAna.date("Ymdhms").'.pdf',"F");
}
//============================================================+
// END OF FILE
//============================================================+
