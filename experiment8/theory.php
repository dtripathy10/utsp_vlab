...
<ul class="test1">
<li>Assume a trial value of α.</li>
<li>Take $ X_{i}$ for example as 1 and determine the value of $ Y_{j}$ from equation (3). 
	Then this value is substituted in equation (2) to find the value of Xi.</li>
...
<li>A series of Gravity Model is obtained by varying the value of α. For each model a 
