...
<html lang="en">
  <head>
    <meta charset="utf-8">
    				<!-- le title -->
  					<title>Trip Distribution | UTSP VLab</title>
		...
		case 1:
			?>
			 <body>
      			...
      			<div  class="brand">
      				<h1><a href="aim.php">Calibration of Singly Constrained Gravity Model</a><span class="caption">Trip Distribution</span></h1>
    			</div>
  				<div class="row">
        			<div class="span8">
          				<ul id="menu-bar">
